...
export const PaginationPrevTrigger = React.forwardRef<HTMLButtonElement, ChakraPagination.PrevTriggerProps>(
  function PaginationPrevTrigger(props, ref) {
    ...
    if (getHref) {
      return (
        <LinkButton to={previousPage != null ? getHref(previousPage) : ''} variant={variantMap.default} size={size}>
          <HiChevronLeft />
        </LinkButton>
      );
    }
...
export const PaginationNextTrigger = React.forwardRef<HTMLButtonElement, ChakraPagination.NextTriggerProps>(
  function PaginationNextTrigger(props, ref) {
    ...
    if (getHref) {
      return (
        <LinkButton to={nextPage != null ? getHref(nextPage) : ''} variant={variantMap.default} size={size}>
          <HiChevronRight />
        </LinkButton>
      );
    }
