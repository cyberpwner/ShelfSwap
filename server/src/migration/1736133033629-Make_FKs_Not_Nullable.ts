...
export class MakeFKsNotNullable1736133033629 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Order\` CHANGE \`seller_id\` \`seller_id\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Order\` CHANGE \`seller_id\` \`seller_id\` int NULL`);
